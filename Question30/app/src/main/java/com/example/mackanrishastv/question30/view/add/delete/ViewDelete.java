package com.example.mackanrishastv.question30.view.add.delete;
...
import com.example.mackanrishastv.question30.presenter.add.delete.PresenterDelete;
import com.example.mackanrishastv.question30.presenter.add.delete.PresenterResponseToViewDeleteListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(getActivity(), "Todo id :" + todo_id, Toast.LENGTH_SHORT).show();
